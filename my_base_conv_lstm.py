...
from my_base_conv_rnn import ConvRNN
#from keras.layers.rnn.dropout_rnn_cell_mixin import DropoutRNNCellMixin  # TODO: compatible with stable keras
from keras.layers.recurrent import DropoutRNNCellMixin
from keras.utils import conv_utils
import tensorflow.compat.v2 as tf


class ConvLSTMCell(DropoutRNNCellMixin, base_layer.Layer):#base_layer.BaseRandomLayer):
  ...
  def __init__(self,
    ...
    self.kernel_size = conv_utils.normalize_tuple(kernel_size, self.rank,
                                                  'kernel_size')
    # TODO: compatible with stable keras
